...
namespace DispatcherWeb.Infrastructure
{
    ...
    public class ShortGuid
    {
        ...
        public override bool Equals(object obj)
        {
            return obj switch
            {
                ShortGuid shortGuid => _guid.Equals(shortGuid._guid),
                Guid guid => _guid.Equals(guid),
                string str when Guid.TryParse(str, out var parsedGuid) => _guid.Equals(parsedGuid),
                _ => false,
            };
        }
