...
namespace DispatcherWeb.Authorization.Users
{
    ...
    public class UserManager : AbpUserManager<Role, User>
    {
        ...
        [Obsolete]
        public new IQueryable<User> Users { get => base.Users; }
        ...
        public override async Task SetGrantedPermissionsAsync(User user, IEnumerable<Permission> permissions)
        {
            ...
            CheckPermissionsToUpdate(user, permissionList);

            await base.SetGrantedPermissionsAsync(user, permissionList);
        }

        public async Task<string> CreateRandomPassword()
        {
            var passwordComplexitySetting = await _passwordComplexitySettingStore.GetSettingsAsync();
        ...
        private void CheckPermissionsToUpdate(User user, List<Permission> permissions)
        {
