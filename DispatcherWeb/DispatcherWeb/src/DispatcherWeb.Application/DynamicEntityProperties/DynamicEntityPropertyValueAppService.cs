...
namespace DispatcherWeb.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : DispatcherWebAppServiceBase, IDynamicEntityPropertyValueAppService
    {
        ...
        public async Task<DynamicEntityPropertyValueDto> Get(int id)
        {
            ...
            return new DynamicEntityPropertyValueDto
            {
                Id = entity.Id,
                Value = entity.Value,
                EntityId = entity.EntityId,
                DynamicEntityPropertyId = entity.DynamicEntityPropertyId,
            };
        }
        ...
        public async Task<ListResultDto<DynamicEntityPropertyValueDto>> GetAll(GetAllInput input)
        {
            var entities = (await _dynamicEntityPropertyValueManager.GetValuesAsync(input.PropertyId, input.EntityId))
                .Select(x => new DynamicEntityPropertyValueDto
                {
                    Id = x.Id,
                    Value = x.Value,
                    EntityId = x.EntityId,
                    DynamicEntityPropertyId = x.DynamicEntityPropertyId,
                }).ToList();
            return new ListResultDto<DynamicEntityPropertyValueDto>(entities);
        ...
        {
            var entity = new DynamicEntityPropertyValue
            {
                Value = input.Value,
        ...
        public async Task Update(DynamicEntityPropertyValueDto input)
        {
            ...
            if (entity == null || entity.TenantId != await AbpSession.GetTenantIdOrNullAsync())
            {
