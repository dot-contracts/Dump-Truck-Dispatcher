...
(function ($) {
    ...
    // This was already commented out partially at some point in the past, so the request did nothing useful.
    // I'm commenting out the entire block completely so that we don't make a call at all if we're not going to apply the received url.
    // We might need this again later when we start supporting multiple languages.
    //
