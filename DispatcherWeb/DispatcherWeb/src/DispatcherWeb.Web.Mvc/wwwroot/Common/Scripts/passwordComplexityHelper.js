(function () {
    app.PasswordComplexityHelper = function () {
        ...
        var _buildPasswordComplexityErrorMessage = function (setting) {
            var message = "<ul class='d-inline-block'>";
        ...
        var _setPasswordComplexityRules = async function ($elements, setting) {
            if (!$elements) {
                return;
            }

            if (!setting) {
                let passwordComplexitySetting = await abp.services.app.profile.getPasswordComplexitySetting();
                setting = passwordComplexitySetting.setting;
            } else {
