(function ($) {
    $(function () {
        ...
        var _$auditLogFilterInputs = _$auditLogFilterForm.find('.filter');
        _$auditLogFilterInputs.on('change', function () {
            if ($(this).data("reload-grid-on-change") === true) {
                getAuditLogs();
            }
        });
        ...
        function createAuditLogRequestParams() {
            var parameters = _dtHelper.getFilterData(_$auditLogFilterInputs);
            return $.extend(parameters, _selectedDateRangeAuditLog);
        }
        ...
        function getAuditLogs() {
            auditLogDataTable.ajax.reload(function () {
                updateTableUI();
            });
        }

        function updateTableUI() {
            const showForAllTenants = $("#ShowForAllTenants").is(":checked");
            auditLogDataTable.column('tenantName:name').visible(showForAllTenants);
        }
