    ...
    $(function () {
        ...
        var organizationTree = {
            ...
            generateTextOnTree: function (ou) {
                ...
                return '<div title="' + ou.code + '" class="ou-text' + itemClass + ' text-ellipsis" data-ou-id="' + ou.id + '">' + app.htmlUtils.htmlEncodeText(ou.displayName) + '</div><div class="float-left"> (<span class="ou-text-member-count">' + ou.memberCount + '</span>) <i class="fa fa-caret-down text-muted"></i></div>';
