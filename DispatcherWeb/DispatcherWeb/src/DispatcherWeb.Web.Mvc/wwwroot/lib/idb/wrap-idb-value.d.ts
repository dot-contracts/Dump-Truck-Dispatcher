...
declare const reverseTransformCache: WeakMap<WeakKey, any>;
declare function replaceTraps(callback: (currentTraps: ProxyHandler<any>) => ProxyHandler<any>): void;
/**
 * Enhance an IDB object with helpers.
 *
 * @param value The thing to enhance.
 */
declare function wrap(value: IDBDatabase): IDBPDatabase;
declare function wrap(value: IDBIndex): IDBPIndex;
declare function wrap(value: IDBObjectStore): IDBPObjectStore;
declare function wrap(value: IDBTransaction): IDBPTransaction;
declare function wrap(value: IDBOpenDBRequest): Promise<IDBPDatabase | undefined>;
declare function wrap<T>(value: IDBRequest<T>): Promise<T>;
/**
