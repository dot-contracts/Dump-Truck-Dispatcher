 ...
 */
declare function openDB<DBTypes extends DBSchema | unknown = unknown>(name: string, version?: number, { blocked, upgrade, blocking, terminated }?: OpenDBCallbacks<DBTypes>): Promise<IDBPDatabase<DBTypes>>;
 ...
 * @param name Name of the database.
 */
declare function deleteDB(name: string, { blocked }?: DeleteDBCallbacks): Promise<void>;
{ unwrap, wrap } from './wrap-idb-value.js';
