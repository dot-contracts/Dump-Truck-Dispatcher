...
(function() {
  ...
  Morris.Hover = (function() {
    ...
    Hover.prototype.html = function(content) {
      let result = this.el.html(content);
      setInlineColors(this.el);
      return result;
    };

    let setInlineColors = function (allElements) {
      let elementsToUpdate = allElements.find('[data-color]');
  ...
  Morris.Line = (function(_super) {
    ...
    Line.prototype.hoverContentForRow = function(index) {
      ...
      for (j = _i = 0, _len = _ref.length; _i < _len; j = ++_i) {
        ...
        content += "<div class='morris-hover-point' data-color='" + this.colorFor(row, j, 'label') + "'>\n  " + this.options.labels[j] + ":\n  " + (this.yLabelFormat(y, j)) + "\n</div>";
      }
